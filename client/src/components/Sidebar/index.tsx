...
const Sidebar = () => {
    const [showProjects, setShorProjects] = useState(true)
            ...
            <div className='flex h-[100%] w-full flex-col justify-start'>
                ...
                <div className='z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-black'>
                    <div className='text-xl font-bold text-gray-800 dark:text-white'>
                        Project<span className='text-blue-primary'>Wise</span>
                    </div>
                    {
                ...
                {/* TEAM */}
                <div className='flex items-center gap-5 border-y-[1.5px] border-gray-600 px-8 py-4  dark:border-gray-700'>
                    <Image src="https://pm-s3-imag.s3.us-east-1.amazonaws.com/logo.png" alt='Logo' width={40} height={40} />
                    <div>
                ...
                {/* PROJECTS LINKS */}
                <button onClick={() => setShorProjects((prev) => !prev)} className='flex w-full items-center justify-between px-8 py-3 text-gray-500' >
